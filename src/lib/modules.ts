...
export const MODULES: ModuleDef[] = [
  ...
  { key: "commission-pipeline", name: "Commission Pipeline", description: "Pending deals, splits & close timing", status: "soon", blockedBy: "CRM or accounting feed" },
  { key: "lead-roi", name: "Lead ROI", description: "Lead source spend to closed profit", status: "soon", blockedBy: "CRM + ad sources" },
