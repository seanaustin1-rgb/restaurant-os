...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;-webkit-print-color-adjust:exact;print-color-adjust:exact}
  ...
  .band{background:var(--band);color:var(--band-text);padding:.12in .5in;height:.72in;position:relative;display:flex;align-items:center;justify-content:space-between;gap:.4in;overflow:hidden}
  ...
  .ring{width:1.42in;height:1.42in;margin:0 auto;border-radius:50%;border:1.8px solid var(--gold);box-shadow:inset 0 0 0 6px var(--parchment),inset 0 0 0 7px rgba(200,135,58,.3);display:flex;flex-direction:column;align-items:center;justify-content:center;position:relative;flex:none;padding:.14in;text-align:center}
  .ring .n{font-family:var(--display);font-size:22px;color:rgba(154,107,47,.34);line-height:1}
  ...
  .ring .oz{position:absolute;bottom:8px;font-family:var(--mono);font-size:7.5px;letter-spacing:.18em;text-transform:uppercase;color:rgba(122,85,38,.5)}
    .stats{display:flex;margin-top:.04in;padding:.04in 0;border-top:1px solid rgba(122,85,38,.22);border-bottom:1px solid rgba(122,85,38,.22)}
  ...
  .row{display:flex;align-items:center;gap:5px;margin-bottom:1px}
  ...
  .tex-wrap{margin-top:3px;padding-top:3px;border-top:1px solid rgba(122,85,38,.14)}
  .notes{margin-top:.04in}
  ...
  .prow .v{font-family:var(--display);font-size:13px;color:var(--ink);line-height:1.2;margin-top:2px;-webkit-line-clamp:2;display:-webkit-box;-webkit-box-orient:vertical;overflow:hidden}
  .foot{background:var(--band);height:.24in;display:flex;align-items:center;justify-content:center;padding:0 .5in;color:#9c876a;flex:none;border-top:1.5px solid rgba(200,135,58,.45)}
